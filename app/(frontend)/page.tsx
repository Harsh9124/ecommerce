...
export default async function Home() {
  ...
  const latestProducts = await productService.getLatest(4, 8);
  ...
  return (
    <div className="container mx-auto">
      <div className="bg-primary my-6 w-full rounded-lg">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between ">
          <div className="lg:pl-60 justify-start m-4">
            ...
            <h1 className="mb-10 font-mono text-xl lg:text-4xl">
              <TypingAnimation />
            </h1>
            <form
              action="/search"
            ...
            >
              <button className="border-2 border-black py-2 px-6 rounded-full hover:btn-primary">
                View More
              </button>
            </form>
          </div>
      ...
      <div>
        <h2 className="text-4xl font-bold my-6">Featured Products</h2>
      ...
      <div>
        <h2 className="text-4xl font-bold my-6">Latest Products</h2>
        <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3 lg:grid-cols-4">
